...
LDFLAGS += -X "$(PD_PKG)/pkg/versioninfo.PDReleaseVersion=v6.6.0-serverless"
...
ifneq ($(DASHBOARD), 0)
	...
	LDFLAGS += -X "github.com/pingcap/tidb-dashboard/pkg/utils/version.PDVersion=v6.6.0-serverless"
